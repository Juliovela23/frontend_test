...
<style scoped>
  .neon-checkbox {
    --primary: #15385c;      /* Azul activo */
    --primary-pink: #f754a5; /* Rosado animación */
    --primary-cyan: #01a7e4; /* Cyan para hover */
    --size: 30px;
    position: relative;
    width: var(--size);
    height: var(--size);
  ...
  .neon-checkbox__glow {
    ...
    inset: -2px;
    border-radius: 6px;
    background: radial-gradient(circle, var(--primary-pink), var(--primary));
    opacity: 0;
    filter: blur(10px);
    transform: scale(1.2);
    transition: all 0.4s ease;
