<template>
  ...
  <div class="flex flex-col items-center min-h-screen pt-8 pb-12 bg-[#f5f7fa]">
    <!-- Filtros arriba -->
    <div class="bg-[#e7eef6] rounded-2xl shadow p-6 md:p-8 w-full max-w-2xl mb-8 border border-[#d1e4f8]">
      ...
      <div class="grid md:grid-cols-2 gap-4 mb-2">
        <div>
          ...
          <select v-model="cuentaSeleccionada"
            class="w-full mt-1 p-2 rounded-xl border border-[#b6d6ff] bg-white text-[#15385c] text-sm focus:outline-[#15385c]">
      ...
      <div class="grid md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input v-model="fechaDesde" type="date"
            class="w-full mt-1 p-2 rounded-xl border border-[#b6d6ff] bg-white text-[#15385c] text-sm" />
        </div>
        <div>
    ...
    <!-- Input de búsqueda más bonito y con ícono -->
      <div
        class="flex items-center bg-white border border-[#b6d6ff] rounded-xl px-3 py-2 mb-4 w-full max-w-md shadow-sm">
