<template>
  ...
  <div class="flex flex-col items-center min-h-screen pt-8 pb-12 bg-[#f5f7fa]">
    ...
    <div class="w-full max-w-6xl px-4">
      ...
      <!-- Input búsqueda -->
      <div class="flex items-center bg-white border border-[#b6d6ff] rounded-xl px-3 py-2 mb-4 w-full max-w-lg mx-auto shadow-sm">
          ...
          <tbody>
            <tr v-for="m in movimientosFiltrados" :key="m.id"
              ...
              <td class="px-4 py-3 text-right font-semibold"
                ...
                {{ m.tipo.toLowerCase() === 'débito' || m.tipo.toLowerCase() === 'debito' ? '- Q' : '+ Q' }}{{ m.monto.toFixed(2) }}
              </td>
            </tr>
